...
public class Onlychat extends JFrame
{
	...
	*/
	...
	public static void main(String[] args)
	{
		SwingUtilities.invokeLater(new Runnable()
		{
			public void run()
			{
				new Onlychat("a").setVisible(true);
				new Onlychat("b").setVisible(true);		
			}
		});
	}
}