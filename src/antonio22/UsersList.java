...
public class UsersList extends JFrame {
	...
	public UsersList(String userName){
	        ...
	        public void keyPressed(KeyEvent evt)
	        {
	            if(evt.getKeyCode() == KeyEvent.VK_ENTER)
	            {
					if (list.getSelectedValue() != userName) {
						...
						pressedButton = (String) list.getSelectedValue();
						System.out.println(pressedButton);
						//System.out.println(userName.equals(pressedButton));
	...
	*/
	...
	public static void main(String[] args) {
		...
		UsersList l = new UsersList("lista");
